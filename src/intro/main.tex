...
When Hastings and Haah's paper appeared, it was not only theoretically interesting, as it expanded our ideas around what it means to be a quantum error correcting code, but the hope was that it might also bring practical advantages -- e.g. in circumventing no-go theorems that shackle static quantum codes.
