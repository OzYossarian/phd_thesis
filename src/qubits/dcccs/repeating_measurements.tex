...
\teague{Notation: $X^a Y^b Z^c$ code not yet defined}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=\linewidth]{figures/qubits/dcccs/repeating_measurements/X1Y1Z1_X2Y2Z2_X3Y3Z3_comparison.pdf}
    \caption{
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.9\linewidth]{figures/qubits/dcccs/repeating_measurements/timelike_distance.pdf}
    \caption{
