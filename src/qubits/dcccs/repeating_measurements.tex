...
In this section, we repeat the edge operator measurements made at each timestep $t$ some number of times $r_t$.
...
In the next subsection we look analytically at what this changes in terms of detectors, logical errors and the decoding graph, and what we expect this to mean for the teraquop volumes.
...
\subsection{Repeated detectors...}\label{subsec:repeating_measurements_detectors}

Suppose an (unrepeated) DCCC has a face detector
...
any timestep $R_t + u_t$ of each set of $r_t$ repeated measurement rounds gives a face detector
...
In addition to these altered face detectors, we also have the new edge detectors as described in the introduction to this section.
...
\subsection{...versus unrepeated detectors}\label{subsubsec:repeating_measurements_volume_measurements_detectors}
...
\subsection{Asymmetric schedules}\label{subsubsec:repeating_measurements_asymmetric_schedules}
...
%            bz = {\filledHexagon},
%        }}\ }\\[5pt]
%        &&&&&\DDD_{tr + r - 1} &&= \pres{\ \scalebox{0.7}{\bosonTable{
%            condensed = rx,
%            rowLabel = e,
%            columnLabel = m,
%            rx = {\filledHexagon},
...
%%    \begin{gathered}
%%        \begin{aligned}
%%            \SSS_{tr + r - 1} &= \pres{\ \scalebox{0.7}{\bosonTable{
%%                condensed = rx,
%%                rowLabel = e,
%%                columnLabel = m,
%%                rx = {\filledHexagon \diagup},
...
\begin{figure}[htbp]
    \centering
    \includegraphics[height=0.7\textheight]{figures/qubits/dcccs/repeating_measurements/spacelike_logical_from_measurement_errors_repeated_DCCC}
    \caption{
...
\begin{figure}[htbp]
    \centering
    \includegraphics[height=0.7\textheight]{figures/qubits/dcccs/repeating_measurements/timelike_logical_from_data_qubit_errors_repeated_DCCC}
    \caption{
...
Repeating measurements has an effect on the number of measurement errors that correspond to degree $> 2$ vertices in the decoding graph.
...
\begin{figure}[htbp]
    ...
    \begin{subfigure}[c]{0.18\textwidth}
        \centering
        \includegraphics[height=200pt]{figures/qubits/dcccs/repeating_measurements/repeated_DCCC_ordinary_edge_measurement_error_a}
        \caption{}
        \label{fig:repeated_DCCC_ordinary_edge_measurement_error_a}
    \end{subfigure}
    \begin{subfigure}[c]{0.18\textwidth}
        \centering
        \includegraphics[height=200pt]{figures/qubits/dcccs/repeating_measurements/repeated_DCCC_ordinary_edge_measurement_error_b}
        \caption{}
        \label{fig:repeated_DCCC_ordinary_edge_measurement_error_b}
    \end{subfigure}
    \begin{subfigure}[c]{0.14\textwidth}
        \centering
        \includegraphics[height=200pt]{figures/qubits/dcccs/repeating_measurements/repeated_DCCC_ordinary_edge_measurement_error_c}
        \caption{}
        \label{fig:repeated_DCCC_ordinary_edge_measurement_error_c}
    \end{subfigure}
    \begin{subfigure}[c]{0.14\textwidth}
        \centering
        \includegraphics[height=200pt]{figures/qubits/dcccs/repeating_measurements/repeated_DCCC_ordinary_edge_measurement_error_d}
        \caption{}
        \label{fig:repeated_DCCC_ordinary_edge_measurement_error_d}
    \end{subfigure}
    \begin{subfigure}[c]{0.14\textwidth}
        \centering
        \includegraphics[height=200pt]{figures/qubits/dcccs/repeating_measurements/repeated_DCCC_ordinary_edge_measurement_error_e}
        \caption{}
        \label{fig:repeated_DCCC_ordinary_edge_measurement_error_e}
    \end{subfigure}
    \begin{subfigure}[c]{0.14\textwidth}
        \centering
        \includegraphics[height=200pt]{figures/qubits/dcccs/repeating_measurements/repeated_DCCC_ordinary_edge_measurement_error_f}
        \caption{}
...
\begin{figure}[htbp]
    ...
    \begin{subfigure}[b]{0.24\textwidth}
        \centering
        \includegraphics[height=330pt]{figures/qubits/dcccs/repeating_measurements/face_detector_neighbourhood_web.png}
        \caption{}
        \label{fig:ZX_plus_init}
    \end{subfigure}
    \begin{subfigure}[b]{0.24\textwidth}
        \centering
        \includegraphics[height=330pt]{figures/qubits/dcccs/repeating_measurements/face_detector_neighbourhood_graph.png}
        \caption{}
        \label{fig:ZX_X_meas}
    \end{subfigure}
    \begin{subfigure}[b]{0.24\textwidth}
        \centering
        \includegraphics[height=330pt]{figures/qubits/dcccs/repeating_measurements/edge_detector_neighbourhood_web.png}
        \caption{}
        \label{fig:ZX_CNOT}
    \end{subfigure}
    \begin{subfigure}[b]{0.24\textwidth}
        \centering
        \includegraphics[height=330pt]{figures/qubits/dcccs/repeating_measurements/edge_detector_neighbourhood_graph.png}
        \caption{}
...
The other key difference pertains to detector vertex degrees in a DCCC's decoding graph.
The degree of detector vertices in a code's decomposed decoding graph in general affects decoding performance: the lower the better~\cite{OscarSubsystemGaugeFixing}.
In any unrepeated DCCC, we said every detector vertex has degree 12 (\Cref{fig:decoding_graph_face_detector_neighbourhood}).
...
\begin{figure}[p]
    \centering
    \includegraphics[width=\textwidth]{figures/qubits/dcccs/introduction/spacetime_volume_heatmap_beliefmatching}
    \caption{
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=\linewidth]{figures/qubits/dcccs/repeating_measurements/X1Y1Z1_X2Y2Z2_X3Y3Z3_comparison}
    \caption{
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=\linewidth]{figures/qubits/dcccs/repeating_measurements/X1Z1_X3Z3_comparison}
    \caption{
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=\linewidth]{figures/qubits/dcccs/repeating_measurements/timelike_distance}
    \caption{
...
\begin{figure}[p]
    \centering
    \includegraphics[width=\textwidth]{figures/qubits/dcccs/introduction/volumes_cln_pymatching}
...
\begin{figure}[p]
    \centering
    \includegraphics[width=\textwidth]{figures/qubits/dcccs/introduction/volumes_cln_beliefmatching}
