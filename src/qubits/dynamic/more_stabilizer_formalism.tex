...
\begin{figure}[tb!]
    \centering
    \tikzfig{qubits/dynamic/codespace_transformation}
    \caption{The effect of applying a Clifford unitary $U$ or performing a Pauli measurement $M_P$ on a codespace $\VVV_\SSS$.
    The former maps $\VVV_\SSS$ unitarily to $\VVV_{\SSS'} = U\VVV_{\SSS}U^\dagger$.
    The latter splits into three cases; \hyperref[thm:stabilizer_group_update_measurement:case1]{Case 1} does nothing, \hyperref[thm:stabilizer_group_update_measurement:case2]{Case 2} maps $\VVV_\SSS$ unitarily to an orthogonal codespace $\VVV_{\SSS'}$, and \hyperref[thm:stabilizer_group_update_measurement:case3]{Case 3} projects $\VVV_\SSS$ to a subspace $\VVV_{\SSS'}$ of half the size.}
    \label{fig:codespace_transformation}
\end{figure}
...
We summarise this in \Cref{fig:codespace_transformation} before looking into each case.
...
\begin{example}\label{ex:bacon_shor_codespace_updates}
    ...
    \end{equation}
    \begin{equation}
        \scalebox{0.8}{\tikzfig{qubits/dynamic/codespace_transformation_example_1}}
    \end{equation}
    ...
    \end{equation}
    \begin{equation}
        \scalebox{0.8}{\tikzfig{qubits/dynamic/codespace_transformation_example_2}}
    \end{equation}
    ...
    \end{equation}
    \begin{equation}
        \scalebox{0.8}{\tikzfig{qubits/dynamic/codespace_transformation_example_3}}
    \end{equation}
\end{example}
