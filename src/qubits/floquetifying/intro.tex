...
In this chapter, we look at how we can take a static stabilizer code defined by measurements of weight perhaps more than two, and reinterpret it as a dynamic stabilizer code in which all measurements are of weight at most two.
The specific static code we look at is the colour code.
One reading of this chapter is that we've taken the PsiQuantum paper \Ccite{Bombin_2024}, which Floquetified the surface code (amongst other things!), and done the same thing for the colour code.
