...
\begin{example}\label{ex:422_stabilizer_code}
    ...
    Viewed as a stabilizer code, this is called the $\qcode{4, 2, 2}$ code (it uses $4$ physical qubits to encode $2$ logical qubits with an \textit{algebraic distance} of $2$.
    We'll define distance properly later in \Cref{subsec:distance}).
