...
We also define the \textit{weight} of an error $F$ under a noise model $\FFF$ to be the least number of atomic errors that can be multiplied together to give $F$.
