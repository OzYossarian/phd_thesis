...
In the notation defined above, we write this as the set $\FFF_{\text{Ph}}$ consisting of the following probability distributions.
...
\end{equation}
Then for all measurements $(J, t)$ we have $\FFF_{J, t} \in \FFF_{\text{Ph}}$, where:
\begin{equation}
