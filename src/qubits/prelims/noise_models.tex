...
In this section, we give a proper definition of a noise model in traditional circuit-centric language, introduce the two most common examples, and then relate them to the non-traditional ZX-centric approach we used throughout the last section.
...
As in the previous section, we will write $C^F$ to denote the circuit $C$ with the error $F$ applied to it.
