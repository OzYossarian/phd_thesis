...
In the qubit half of this thesis, when discussing noise models, we first swapped to a traditional circuit-based view, then later showed that the ZX-based approach actually encompassed the traditional one.
In this qumode half, we will just skip straight to the ZX-based approach.
