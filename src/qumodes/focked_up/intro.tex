...
The content in this chapter will appear at some point as a paper; the working title is \textit{Focked up Fault-Equivalence}~\cite{townsendteague2026fockedup}.

In the first section of this chapter, we show that the ZX-calculus can move us between static and dynamic implementations of GKP codes, just like in \Cref{ch:floquetifying}, which itself was based on \Ccite{Bombin_2024}.
