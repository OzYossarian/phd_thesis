...
In the qubit case we took a very close look at the stabilizer formalism and gave a general definition of dynamic stabilizer codes, long before we turned to a graphical approach via the ZX-calculus and Pauli webs.
...
The difficulty will be that our ZX-diagrams contain Gaussian spiders, which are stabilized by a continuous set of stabilizers, and comb spiders, which are stabilized by a discrete set of stabilizers.
Combining both discrete and continuous sets of stabilizers into one stabilizer formalism appears to be non-trivial.
