...
\begin{figure}[p]
    \centering
    \includegraphics[width=0.9\linewidth]{figures/dcccs/teraquop_volume/teraquop_volume_schematic}
    \caption{
    ...
    \includegraphics[width=0.9\linewidth]{figures/dcccs/teraquop_volume/X1Y1Z1_X1Z1_teraquop_linefits}
    \caption{
...
\begin{figure}[t]
    \centering
    \includegraphics[width=\linewidth]{figures/dcccs/teraquop_volume/volume_verification}
    \caption{
