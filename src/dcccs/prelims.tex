...
\begin{figure}[htbp!]
    \centering
    \includegraphics[width=180pt]{figures/dcccs/prelims/edge_and_face_operator}
    \caption{
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=\linewidth]{figures/dcccs/prelims/schedules_XYZ_and_CSS_measurements_next_to}
    \caption{
...
\begin{figure}[b]
    \centering
    \includegraphics[width=\linewidth]{figures/dcccs/prelims/logicals_XYZ_and_XZ_stacked_horizontal}
    \caption{
...
\begin{figure}[p]
    ...
    \begin{subfigure}[c]{0.14\textwidth}
        \centering
        \includegraphics[width=0.8\textwidth]{figures/dcccs/prelims/ZX_X_gate}
        \caption{}
        \label{fig:ZX_X_gate}
    \end{subfigure}
    \begin{subfigure}[c]{0.14\textwidth}
        \centering
        \includegraphics[width=0.8\textwidth]{figures/dcccs/prelims/ZX_Y_gate}
        \caption{}
        \label{fig:ZX_Y_gate}
    \end{subfigure}
    \begin{subfigure}[c]{0.14\textwidth}
        \centering
        \includegraphics[width=0.8\textwidth]{figures/dcccs/prelims/ZX_Z_gate}
        \caption{}
        \label{fig:ZX_Z_gate}
    \end{subfigure}
    \begin{subfigure}[c]{0.27\textwidth}
        \centering
        \includegraphics[width=0.8\textwidth]{figures/dcccs/prelims/ZX_XX_meas_X_error}
        \caption{}
        \label{fig:ZX_XX_meas_X_error}
    \end{subfigure}
    \begin{subfigure}[c]{0.27\textwidth}
        \centering
        \includegraphics[width=0.8\textwidth]{figures/dcccs/prelims/ZX_XX_meas_error}
        \caption{}
    ...
    \begin{subfigure}[b]{0.2\textwidth}
        \centering
        \includegraphics[width=0.6\textwidth]{figures/dcccs/prelims/ZX_plus_init}
        \caption{}
        \label{fig:ZX_plus_init}
    \end{subfigure}
    \begin{subfigure}[b]{0.2\textwidth}
        \centering
        \includegraphics[width=0.6\textwidth]{figures/dcccs/prelims/ZX_X_meas}
        \caption{}
        \label{fig:ZX_X_meas}
    \end{subfigure}
    \begin{subfigure}[b]{0.3\textwidth}
        \centering
        \includegraphics[width=0.7\textwidth]{figures/dcccs/prelims/ZX_CNOT}
        \caption{}
        \label{fig:ZX_CNOT}
    \end{subfigure}
    \begin{subfigure}[b]{0.45\textwidth}
        \centering
        \includegraphics[width=0.7\textwidth]{figures/dcccs/prelims/ZX_XX_meas_circuit_YZ_error}
        \caption{}
        \label{fig:ZX_XX_meas_circuit_YZ_error}
    \end{subfigure}
    \begin{subfigure}[b]{0.45\textwidth}
        \centering
        \includegraphics[width=0.7\textwidth]{figures/dcccs/prelims/ZX_XX_meas_circuit_meas_error}
        \caption{}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=0.8\linewidth]{figures/dcccs/prelims/detectors_XYZ_and_CSS}
    \caption{
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.8\textwidth]{figures/dcccs/prelims/XYZ_measurement_error_hyperedge}
    \caption{
...
\begin{figure}[htb]
    \centering
    \includegraphics[height=0.55\textheight]{figures/dcccs/prelims/decoding_graph_face_detector_neighbourhood}
    \caption{
...
\begin{figure}[htpb]
    \centering
    \includegraphics[width=\linewidth]{figures/dcccs/prelims/XYZ_logical_data_qubit_errors}
    \caption{
